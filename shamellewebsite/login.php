<?php
    ...
    if (isset($_POST["login"])){
        ...
        $login_successful = mysqli_num_rows($result) > 0;
...
<head>
    ...
    <meta name="google-signin-client_id" content="10167173615-pgcdfr0b0p5kl6tn4glvqie457oam2t0.apps.googleusercontent.com">
...
<body>
  ...
  <div class="popup" id="popup-login" style="display: none">
    ...
    <div class="text">
     ...
     <span class="msg">Invalid Account!</span>
